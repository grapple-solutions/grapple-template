<script>
  ...
  import privacySection from "./privacy.json";

  import mbdPrivacy from "../../assets/mbd_privacy_policy.pdf";
...
<div class="relative">
  <div class="grid gap-3">
    ...
    >
      <div class="grid gap-6">
        {#each privacySection as section, sectionIndex}
          <div>
            <div
  ...
  <div class="flex justify-end mt-4">
    <a href={mbdPrivacy} download class="button font-CorpoS text-sm"
      >{$_("Download")}</a
    >
  </div>
</div>
