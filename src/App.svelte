<script>
  ...
  let el1;
    import("App/Customers/count").then((module) => {
  ...
  let el2;
    import("App/Customers/findById").then((module) => {
    ...
    new FindById({
      ...
      props: {
        id: 103,
        schema: { "field-properties": { "field-order": ["id", "customerName", "contactLastName", "contactFirstName", "postalCode", "city", "country"], "hidden-fields": ["state", "addressLine2", "creditLimit"], "date-fields": [ { name: "orderDate", type: "date", }, { name: "shippedDate", type: "time", }, ], }, },
  ...
  let el3;
    import("App/Customers/find").then((module) => {
    ...
    new Find({
      ...
      props: {
        ...
        translation: { 
          ...
          "postalCode": "PLZ",
          "city": "Ort",
          "No more items": "Es gibt keine weiteren Elemente mit diesen Kriterien",
          "Load More": "Weitere Elemente anzeigen"
        },
        // dateFormat: 'DD.MM.YYYY - HH:mm',
        // // useLocalTimezone: true,
        enableFilter: false, enableLoadMore: false, 
        // css: "color: orange;  font-weight: bold; border-color: orange; ",
  ...
  <div class="max-w-6xl m-auto felx p-8">
    ...
    <div class="p-8 grid gap-3">
      <div>
        ...
        <div class="" bind:this={el1} style="width:350px;"/>
        <div class="" bind:this={el2} />
        <div class="" bind:this={el3} />
      </div>
    </div>
  </div>
